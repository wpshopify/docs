...
Displays the "storefront" component containing filtering, pagination, and sorting. Only available in [WP Shopify Pro](https://wpshopify-web.loc/purchase/). Take note that this shortcode contains three required attributes.<br><br>Watch our [quick video tutorial](https://www.youtube.com/watch?v=lYm6G35e8sI) to learn how to use this.
