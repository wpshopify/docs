...
Displays the "storefront" component containing filtering, pagination, and sorting. Take note that this shortcode contains three required attributes.<br><br>Watch our [quick video tutorial](https://www.youtube.com/watch?v=lYm6G35e8sI) to learn how to use this.
