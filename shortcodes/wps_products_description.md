...
Displays the product "description" component.<br><br>Watch our [quick video tutorial](https://www.youtube.com/watch?v=lYm6G35e8sI) to learn how to use this.
...
```js
[wps_products_description tag="Tag A, Tag B"]
```
...
```js
[wps_products_description vendor="Vendor A, Vendor B"]
```
...
```js
[wps_products_description product_type="Books"]
```
...
```js
[wps_products_description available_for_sale="available"]
```
...
```js
[wps_products_description created_at="2019-02-21 03:16:41"]
```
...
```js
[wps_products_description updated_at="2019-02-21 03:16:41"]
```
...
```js
[wps_products_description product_id="2216928411696, 93283473232"]
```
...
```js
[wps_products_description sort_by="price"]
```
...
[wps_products_description sort_by="title" reverse="true"]
```
...
[wps_products_description page_size="4"]
```
...
[wps_products_description page_size="2" limit="10"]

// Only show one product
[wps_products_description limit="1"]
```
...
[wps_products_description title="Awesome product, Even better product" connective="or"]

// Only products with both Tag1 and Tag2 will show
[wps_products_description tag="Tag1, Tag2" connective="and"]
```
...
[wps_products_description excludes="title, pricing"]
```
...
```js
[wps_products_description items_per_row="5"]
```
...
```js
[wps_products_description pagination="false"]
```
...
```js
[wps_products_description infinite_scroll_offset="-100"]
```
...
```js
[wps_products_description dropzone_load_more="#my-custom-load-more-container"]
```
